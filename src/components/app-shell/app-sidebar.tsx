...
export async function AppSidebar({ user }: { user: SessionUser }) {
  ...
  return (
    <aside className="sticky top-14 h-[calc(100svh-3.5rem)] w-60 shrink-0 overflow-y-auto border-r bg-sidebar">
      <nav aria-label={t("label")} className="flex flex-col gap-1 p-3">
